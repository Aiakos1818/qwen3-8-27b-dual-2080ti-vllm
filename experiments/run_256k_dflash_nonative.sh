...
export VLLM_QWOPUS_MTP_BF16_DRAFT=0
...
export VLLM_FLASHINFER_NATIVE_SPEC_AS_DECODE=0
...
ARGS=(
  ...
  --speculative-config "{\"method\":\"dflash\",\"model\":\"$REPO_ROOT/models/Qwen3.8-27B-DFlash2\",\"num_speculative_tokens\":7}"

#!/usr/bin/env bash
# Temp launcher: identical to scripts/run_vllm_qwen38_awq_fp8e4m3_500k.sh
# plus iteration-detail logging and a torch profiler dir. Repo scripts untouched.
set -Eeuo pipefail
...
ARGS=(
  ...
  --profiler-config '{"profiler":"torch","torch_profiler_dir":"/tmp/vllm-prof","torch_profiler_with_stack":false,"torch_profiler_record_shapes":true}'
)

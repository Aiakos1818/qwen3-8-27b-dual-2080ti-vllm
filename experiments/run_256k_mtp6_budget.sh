...
export VLLM_USE_V2_MODEL_RUNNER=1   # A/B: V2 baseline
...
ARGS=(
  ...
  --compilation-config '{"cudagraph_mode":"FULL_AND_PIECEWISE","cudagraph_capture_sizes":[7],"max_cudagraph_capture_size":7}'
  ...
  --reasoning-config '{"reasoning_start_str":"<think>","reasoning_end_str":"</think>","default_thinking_token_budget":512}'
